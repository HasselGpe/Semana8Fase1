...
Como siempre al empezar a trabajar en un proyecto corre el comando bundle para instalar las 
gemas necesarias.
...
En el archivo db/seeds.rb crea entre 10 y 15 registros de prueba utilizando los métodos de 
ActiveRecord.

Juega con ellos en la consola y verifica que se crearon correctamente. Puedas entrar a la 
consola con rake console.
